...
### آزمون توسعه
با Node.js و Playwright دارای Chromium: `node tests/regression.cjs` و `node tests/storage-regression.cjs`.
...
آزمون ذخیره‌سازی، ظرفیت پر localStorage، مهاجرت به IndexedDB و Pull اتمی بزرگ را نیز بررسی می‌کند.
