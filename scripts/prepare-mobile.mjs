...
for (const f of ['mobile.css','next.css','platform.js','shell.js','mobile.js','pages.js','wizard.js','onboarding.js','settings.js','data.js','rollback.js','android.js','next-domain.js','next-app.js','next-ui.js','rescue.html']) await copyFile('mobile/'+f,'www/'+f);
